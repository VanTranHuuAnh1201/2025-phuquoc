...
export function RoomDetailPage({
    ...
    return (
        ...
        >
            ...
            <LightCrumbs
                crumbs={[
                    { label: t.home, href: '/h1' },
                    { label: t.roomsPage, href: '/h1/rooms' },
            ...
            <section style={{ background: 'var(--surface)', padding: '44px 24px 88px' }}>
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="h1-other-grid" style={{ display: 'grid', gap: 18 }}>
                            {others.map((other) => (
                                <a
                                    key={other.id}
                                    href={`/h1/rooms/${other.id}`}
                                    className="h1-other-card"
                                    style={{
                                        display: 'block',
                                        border: '1px solid var(--border)',
                                        borderRadius: 'var(--radius-lg)',
            ...
            <style>{`
                ...
                @media (max-width: 720px) {
                    ...
                    .h1-detail-gallery > *:not(:first-child) { display: none; }
                }
                @media (min-width: 980px) {
                    .h1-detail-layout {
                        grid-template-columns: minmax(0, 1fr) minmax(0, 360px);
                    }
                    .h1-detail-aside { position: sticky; top: 100px; }
                }
                @media (min-width: 640px) {
                    .h1-spec-grid { grid-template-columns: repeat(4, minmax(0, 1fr)); }
                    .h1-amenity-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
                    .h1-two-col { grid-template-columns: repeat(2, minmax(0, 1fr)); }
                    .h1-other-grid { grid-template-columns: repeat(3, minmax(0, 1fr)); }
                }
                .h1-other-card { transition: box-shadow 200ms ease, transform 200ms ease; }
                .h1-other-card:hover { box-shadow: var(--shadow); transform: translateY(-4px); }
            `}</style>
        </div>
    )
}
