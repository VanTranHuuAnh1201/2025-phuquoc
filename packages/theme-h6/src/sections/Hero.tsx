...
export function Hero({ data, locale }: { data: PropertyData; locale: Locale }) {
    ...
    return (
        <section id="top" style={{ position: 'relative' }}>
            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        inset: 0,
                        background:
                            'linear-gradient(180deg, rgba(20,34,44,0.18) 0%, rgba(20,34,44,0.05) 40%, rgba(20,34,44,0.62) 100%)',
                    }}
                />
                    ...
                    >
                        <div style={{ display: 'grid', gap: 'var(--space-3)' }}>
                            <SearchFields
                                ...
                                columns
                            />
                            <a className="h6-btn h6-btn-primary h6-hero-cta" href={findHref}>
                                {t.ctaMain}
                            </a>
                        </div>
                    </div>
            ...
            <style>{`
                .h6-hero-cta { justify-self: end; min-width: 240px; }
                .h6-hero-cta-mobile { display: none; width: 100%; }
                @media (min-width: 900px) {
                    .h6-hero-widget {
                        transform: translateY(var(--space-5));
                        margin-top: calc(-1 * var(--space-3));
                    }
                    .h6-hero { margin-bottom: var(--space-6); }
                }
                @media (max-width: 899.98px) {
                    .h6-hero { min-height: 92vh; }
                    .h6-hero-title { font-size: var(--font-size-2xl) !important; }
                    .h6-hero-widget { display: none; }
                    .h6-hero-cta-mobile { display: inline-flex; }
