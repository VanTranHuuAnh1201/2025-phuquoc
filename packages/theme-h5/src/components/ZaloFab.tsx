...
export function ZaloFab({
    ...
    return (
        ...
        >
            <IconZalo size={26} />
            <style>{`
                .h5-zalo-fab:hover { border-color: var(--color-brand); box-shadow: var(--shadow-lg); }
                .h5-zalo-fab:active { filter: brightness(0.96); }
                @media (min-width: 900px) {
                    .h5-zalo-fab { bottom: 24px; }
                }
            `}</style>
        </a>
    )
