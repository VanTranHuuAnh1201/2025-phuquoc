...
export function Contact({ data, locale }: { data: PropertyData; locale: Locale }) {
    ...
    return (
        ...
        >
            <div className="h5-container" style={{ padding: 'var(--space-6) var(--space-4)' }}>
                <div
                    className="h5-contact-grid"
                ...
                >
                    ...
                    <div className="h5-contact-actions" style={{ display: 'grid', gap: 'var(--space-2)', alignContent: 'start' }}>
                        <p className="h5-kicker" style={{ color: 'var(--color-text-inverse)', opacity: 0.8, margin: 0 }}>
                            {t.contactKicker}
                        </p>
                        <a
            ...
            <style>{`
                @media (min-width: 900px) {
                    .h5-contact-grid { grid-template-columns: minmax(0, 7fr) minmax(0, 5fr); }
                }
                @media (max-width: 899.98px) {
                    /* K7: Zalo + hotline lên đầu trên mobile. */
                    .h5-contact-actions { order: -1; }
                }
            `}</style>
        </footer>
    )
