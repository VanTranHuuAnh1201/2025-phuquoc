 ...
 * Dữ liệu tour hiển thị gọn ở đây vì Home mẫu 05 bỏ section `tours`
...
export function Places({ data, locale }: { data: PropertyData; locale: Locale }) {
    ...
    return (
        <section id="places" style={{ padding: 'var(--space-7) 0 0' }}>
            <div className="h5-places-hero" style={{ position: 'relative', minHeight: '60vh' }}>
            ...
            <div className="h5-container" style={{ paddingTop: 'var(--space-5)' }}>
