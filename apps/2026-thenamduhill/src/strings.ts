...
export const S = {
    ...
    housekeepingRoomTypeAria: t('Lọc theo hạng phòng', 'Filter by room type'),
    housekeepingGroupByLabel: t('Xem theo', 'Group by'),
    housekeepingGroupByAria: t('Cách nhóm danh sách phòng', 'How to group the room list'),
    housekeepingGroupByStatus: t('Trạng thái', 'Status'),
    housekeepingGroupByRoomType: t('Hạng phòng', 'Room type'),
    housekeepingNeedsAttention: t(
        'phòng cần dọn ngay',
    ...
    housekeepingBackToService: t('Đưa lại vào sử dụng', 'Return to service'),
    ...
    emptyAccountsAll: t(
        'Chưa có tài khoản nào. Bấm "Thêm tài khoản" để cấp tài khoản đầu tiên.',
        'No accounts yet. Click "Add account" to create the first one.',
    ),
    accountsKpiTotal: t('Tổng số tài khoản', 'Total accounts'),
    accountsKpiActive: t('Đang hoạt động', 'Active'),
    accountsKpiAdmin: t('Quản trị viên', 'Administrators'),
    accountsKpiReception: t('Lễ tân & vận hành', 'Reception & operations'),
    accountsFullAccessNote: t('Toàn quyền', 'Full access'),
    accountsDailyShiftNote: t('Ca trực hàng ngày', 'Daily shift'),
    deleteAccountAria: t('Xóa tài khoản', 'Delete account'),
    deleteAccountConfirm: t(
        'Xóa tài khoản này? Người dùng sẽ mất quyền truy cập CMS ngay lập tức.',
        'Delete this account? The user will lose CMS access immediately.',
    ),
    createAccountModalTitle: t('Cấp tài khoản & phân quyền mới', 'Grant new account & permissions'),
    fieldUsername: t('Tên đăng nhập (Username)', 'Username'),
    fieldUsernamePlaceholder: t('Ví dụ: letan.namdu', 'e.g. letan.namdu'),
    fieldRbacRole: t('Vai trò hệ thống (RBAC Role)', 'System role (RBAC)'),
    fieldFullName: t('Họ và tên người dùng', 'Full name'),
    fieldFullNamePlaceholder: t('Ví dụ: Nguyễn Văn Hải', 'e.g. Nguyen Van Hai'),
    fieldPhone: t('Số điện thoại', 'Phone number'),
    fieldPhonePlaceholder: t('Ví dụ: 0912 345 678', 'e.g. 0912 345 678'),
    fieldEmailPlaceholder: t('Ví dụ: user@thenamduhill.vn', 'e.g. user@thenamduhill.vn'),
    createAccountCta: t('Tạo tài khoản', 'Create account'),
    loadingAccounts: t('Đang tải danh sách tài khoản…', 'Loading accounts…'),
    loadAccountsFailed: t('Không tải được danh sách tài khoản.', 'Failed to load accounts.'),
    accountJustCreated: t('Mới tạo', 'Just created'),
    roleSuperadmin: t('Super Admin', 'Super Admin'),
    roleOwner: t('Chủ cơ sở (Owner)', 'Owner'),
    roleManager: t('Quản lý (Manager)', 'Manager'),
    roleReceptionist: t('Lễ tân (Receptionist)', 'Receptionist'),
    roleHousekeeping: t('Buồng phòng (Housekeeping)', 'Housekeeping'),
    roleSuperadminOwnerFilter: t('Super Admin / Owner', 'Super Admin / Owner'),
