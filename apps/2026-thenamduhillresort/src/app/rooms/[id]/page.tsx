...
export default function RoomDetailPage({ params }: RoomDetailPageProps) {
  ...
  return (
    <main className="nd-page-main" style={{ paddingTop: '90px', minHeight: '100vh', background: '#ffffff', color: '#0b1b26' }}>
      ...
      <div className="nd-section-container" style={{ maxWidth: '1320px', margin: '0 auto', padding: '16px 32px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 0 16px', fontSize: '13px', color: '#8fa5b3', fontWeight: 600, flexWrap: 'wrap' }}>
          <Link href="/" style={{ color: '#8fa5b3', textDecoration: 'none' }}>
            {t('Trang chủ', 'Home')}
          </Link>
          <span>›</span>
          <Link href="/rooms" style={{ color: '#8fa5b3', textDecoration: 'none' }}>
            {t('Phòng nghỉ', 'Rooms')}
          </Link>
          <span>›</span>
      ...
      <section className="nd-section-container" style={{ maxWidth: '1320px', margin: '0 auto', padding: '0 32px' }}>
        <div
        ...
        >
          ...
          <div
            onClick={() => setLightbox(true)}
            style={{ position: 'relative', borderRadius: '8px 24px 8px 8px', overflow: 'hidden', background: '#eef4f8', cursor: 'zoom-in', minHeight: '130px' }}
          >
          ...
          <div
            onClick={() => setLightbox(true)}
            style={{ position: 'relative', borderRadius: '8px 8px 24px 8px', overflow: 'hidden', background: '#eef4f8', cursor: 'zoom-in', minHeight: '130px' }}
          >
      ...
      {/* Main Content Layout */}
      <section className="nd-section-container" style={{ maxWidth: '1320px', margin: '0 auto', padding: '40px 32px 64px' }}>
        <div className="nd-grid-responsive" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.65fr) minmax(0, 1fr)', gap: '48px', alignItems: 'start' }}>
          {/* Main Info */}
          <div>
            ...
            <h1 style={{ margin: '0 0 12px', fontSize: 'clamp(28px, 3.4vw, 44px)', lineHeight: 1.08, fontWeight: 800, color: '#0b1b26' }}>
              {isEn ? room.nameEn : room.name}
            </h1>

            <p style={{ margin: '0 0 28px', fontSize: '16.5px', lineHeight: 1.62, color: '#566e7d' }}>
              {isEn ? room.blurbEn || room.viewEn : room.blurb || room.view}
            </p>

            {/* 4 Specs Cards */}
            <div className="nd-grid-responsive" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: '10px', marginBottom: '40px' }}>
              <div style={{ border: '1px solid #e6eef4', borderRadius: '16px', padding: '16px 18px', background: '#ffffff' }}>
            ...
            {/* Room Descriptions / Highlights if available */}
            {room.description && room.description.length > 0 && (
              <div style={{ marginBottom: '40px' }}>
                <h2 style={{ margin: '0 0 14px', fontSize: '22px', fontWeight: 800, color: '#0b1b26' }}>
                  {t('Mô tả chi tiết', 'Detailed description')}
                </h2>
                <div style={{ display: 'grid', gap: '12px', fontSize: '15px', lineHeight: 1.65, color: '#3d5462' }}>
            ...
            <div className="nd-grid-responsive" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: '10px 20px', marginBottom: '40px' }}>
            ...
            <div className="nd-grid-responsive" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '12px' }}>
          ...
          <aside style={{ position: 'sticky', top: '100px' }}>
            <div style={{ border: '1px solid #e6eef4', borderRadius: '24px', boxShadow: '0 14px 40px rgba(6,40,58,0.09)', padding: '24px', background: '#ffffff' }}>
              ...
              <div className="nd-grid-responsive" style={{ display: 'grid', gridTemplateColumns: '108px minmax(0, 1fr)', gap: '14px', alignItems: 'center', marginBottom: '16px' }}>
      ...
      {lightbox && (
        ...
        >
          ...
          <div
            ...
            style={{ flex: 1, overflowY: 'auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '12px' }}
          >
