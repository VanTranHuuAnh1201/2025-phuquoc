...
const STAGES = [
  {
    ...
    photo: '/uploads/pasted-1785690604574-0.png',
  ...
  },
  {
    ...
    photo: '/uploads/pasted-1785690635080-0.png',
  ...
  },
  {
    ...
    photo: '/uploads/pasted-1785690771266-0.png',
  ...
  },
  {
    ...
    photo: '/uploads/pasted-1785690646676-0.png',
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '12px' }}>
                <span
                  ...
                  style={{
                    fontSize: '12px',
                    fontWeight: 700,
                    color: stageIndex === 0 ? '#ffffff' : 'rgba(255,255,255,0.64)',
                    cursor: 'pointer',
                  }}
                >
                  {t('Sáng sớm', 'Early morning')}
                </span>
                <span
                  ...
                  style={{
                    fontSize: '12px',
                    fontWeight: 700,
                    color: stageIndex === 1 ? '#ffffff' : 'rgba(255,255,255,0.64)',
                    cursor: 'pointer',
                  }}
                >
                  {t('Giữa trưa', 'Midday')}
                ...
                <span
                  ...
                  style={{
                    fontSize: '12px',
                    fontWeight: 700,
                    color: stageIndex === 2 ? '#ffffff' : 'rgba(255,255,255,0.64)',
                    cursor: 'pointer',
                  }}
                >
                  {t('Hoàng hôn', 'Sunset')}
                ...
                <span
                  ...
                  style={{
                    fontSize: '12px',
                    fontWeight: 700,
                    color: stageIndex === 3 ? '#ffffff' : 'rgba(255,255,255,0.64)',
                    cursor: 'pointer',
                  }}
                >
                  {t('Lên đèn', 'After dark')}
                </span>
              </div>
            </div>
          </div>
