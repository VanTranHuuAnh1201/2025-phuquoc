...
> ⚠️ **Đã lên monorepo (08/2026).** Repo giờ dùng **pnpm workspaces**, không
> dùng yarn nữa. Code Pho Group nói trong tài liệu này nằm ở `apps/2025-phogroup/`.
> Xem [CLAUDE.md](../../CLAUDE.md) cho cấu trúc hiện tại.

```bash
cd d:\2026\2025-phuquoc
pnpm install
pnpm --filter @repo/2025-phogroup dev   # http://localhost:3001 → redirect /vi
